...
const listkey = ["Akira-Key", "Akira-Apikey"];
...
router.get('/random/quotes', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://python-api-kirrr.herokuapp.com/api/random/quotes`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/muslim/hadits', async (req, res, next) => {
    ...
    if (!nomor) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter nomor"})
       ...
       fetch(encodeURI(`https://hadits-api-kirrr.vercel.app/books/${kitab}/${nomor}`))
        .then(response => response.json())
        .then(data => {
             res.json(
             data
...
router.get('/random/quotes/muslim', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://docs-api-akira.herokuapp.com/api/quote?type=agamis`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/asmaulhusna', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://python-api-kirrr.herokuapp.com/api/random/asmaulhusna`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/info/wikipedia', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://docs-api-akira.herokuapp.com/api/wiki?keyword=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/info/drakorasia', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`http://docs-api-akira.herokuapp.com/api/drakorasia?search=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fakedata', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://fakename-api-kirrr.vercel.app/api/fakename?country=${country}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/hilih', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://hilih-api-kirrr.vercel.app/api/hilih?kata=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/music/chordlagu', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://python-api-kirrr.herokuapp.com/api/chord?q=${lagu}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/info/kbbi', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://kbbi-api-kirrr.vercel.app/api/kbbi?text=${kata}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/info/covidindo', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://covid19-api-kirrr.vercel.app/api/covid-indonesia`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/info/covidworld', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://covid19-api-kirrr.vercel.app/api/world`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/meme', async (req, res, next) => {
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://docs-api-akira.herokuapp.com/api/meme`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
